...
class SurveyController extends Controller
{
    ...
    public function submitAlumniSurveyForm(Request $request)
    {
        $request->validate([
            ...
            'employer_address' => 'nullable|required_if:is_employed,1|string',
            'is_employed' => 'boolean|required_with:is_employed|in:1,0',
            'employment_status_id' => 'nullable|required_if:is_employed,1|exists:employment_statuses,id',
            'present_position' => 'nullable|required_if:is_employed,1|string|max:255',
            'inclusive_from' => 'nullable|required_if:is_employed,1|integer',
            'inclusive_to' => 'nullable|required_if:is_employed,1|integer|gte:inclusive_from',
            'monthly_income_id' => 'nullable|required_if:is_employed,1|exists:monthly_incomes,id',
            ...
            'suggestions' => 'nullable|required_if:is_employed,1|string',
